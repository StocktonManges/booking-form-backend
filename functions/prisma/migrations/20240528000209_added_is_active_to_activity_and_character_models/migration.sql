/*
  ...
  - Made the column `howDidYouFindUs` on table `Event` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Activity" ("id", "name") SELECT "id", "name" FROM "Activity";
DROP TABLE "Activity";
