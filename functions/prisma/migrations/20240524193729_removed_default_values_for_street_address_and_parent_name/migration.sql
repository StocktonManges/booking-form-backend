...
INSERT INTO "new_Event" ("addressId", "birthdayChildAge", "birthdayChildName", "couponCode", "dateTime", "email", "firstInteraction", "howDidYouFindUs", "id", "indoors", "maxParticipantAge", "minParticipantAge", "notes", "packageId", "parentName", "participants", "phoneNumber", "referralCode", "statusId") SELECT "addressId", "birthdayChildAge", "birthdayChildName", "couponCode", "dateTime", "email", "firstInteraction", "howDidYouFindUs", "id", "indoors", "maxParticipantAge", "minParticipantAge", "notes", "packageId", "parentName", "participants", "phoneNumber", "referralCode", "statusId" FROM "Event";
DROP TABLE "Event";
...
INSERT INTO "new_Address" ("city", "id", "state", "street") SELECT "city", "id", "state", "street" FROM "Address";
DROP TABLE "Address";
